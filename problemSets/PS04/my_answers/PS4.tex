...
\begin{description}
	\item The p-value of 0.999 is greater than 0.05, therefore we fail to reject the null hypothesis, therefore, these signs in assigned and adjacent precincts have no affect on Ken Cuccinelli's vote share. 
\end{description}
\end{enumerate}  
